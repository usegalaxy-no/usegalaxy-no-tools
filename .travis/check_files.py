...
valid_section_labels = [
    'Animal Detection on Acoustic Recordings', 'Annotation', 'Apollo',
    'Assembly', 'BED', 'ChemicalToolBox', 'Climate Analysis', 'Collection Operations',
    'Convert Formats', 'DNA Metabarcoding', 'EMBOSS', 'Epigenetics', 'Evolution',
    'FASTA/FASTQ', 'FASTQ Quality Control', 'Fetch Sequences', 'Fetch Sequences / Alignments',
    'Filter and Sort', 'GATK Tools', 'GIS Data Handling', 'Gemini', 'Genome Diversity',
    'Genome editing', 'Get Data', 'Get scRNAseq data', 'Graph/Display Data', 'GraphClust',
    'HCA-Single Cell', 'HiCExplorer', 'Imaging', 'Join, Subtract and Group', 'Machine Learning',
    'Mapping', 'Metabolomics', 'Metagenomic Analysis', 'MiModD', 'Mothur', 'Motif Tools',
    'Multiple Alignments', 'NCBI Blast', 'Nanopore', 'OBO Ontology manipulation',
    'Operate on Genomic Intervals', 'Other Tools', 'Peak Calling', 'Phenotype Association',
    'Phylogenetics', 'Picard', 'Proteomics', 'Qiime', 'Quality Control', 'RAD-seq',
    'RNA Analysis', 'RNA-Seq', 'Regional Variation', 'SAM/BAM', 'SAM/BAM Manipulation',
    'Scanpy', 'Send Data', 'Single-cell', 'Species abundance', 'Statistics', 'Test Tools',
    'Text Manipulation', 'VCF/BCF', 'Variant Calling', 'Virology', 'deepTools', 'None',
]

# usegalaxy.au.org:
valid_section_labels_au = [
